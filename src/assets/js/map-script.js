	...
	function initialize() {
		...
		//VARS FOR LATITUTDE AND LOGITUDE
		//=======================================================================================		
		var latitude = 40.77793979999999;
		var longitude = -111.88538749999998;
		...
		var marker1 = new MarkerWithLabel({
       		...
       		icon: ' ',
       		map: map, 
         	labelContent: '<div class="de-icon circle medium-size" style="background-color:#FFF; border:1px solid #4e6b86"><i class="de-icon-heart" style="color:#4e6b86"></i></div>',
		...
		var marker5 = new MarkerWithLabel({
       		...
       		icon: ' ',
       		map: map, 
         	labelContent: '<div class="de-icon circle small-size" style="background-color:#4e6b86"><i class="de-icon-basket"></i></div>',
       		labelAnchor: new google.maps.Point(0, 0),
       		labelClass: "labels" // the CSS class for the label
     		});	
